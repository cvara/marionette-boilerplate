...
// Common conditional classes gathered here for convenience
...
// Options that affect the synergy with the datetimepicker plugin
var dateTimePickerOptions = {
	// These help moment parse dates generated by the datetimepicker
	momentDateFormats: [
		'D MMM YYYY',
		'D MMMM YYYY',
		'MMM D YYYY'
	...
	_consumeDates: function(data) {
		...
		this.ui.datetimeInput.each(function() {
			...
			if (!!name && name in parsed) {
				var date = moment(parsed[name], dateTimePickerOptions.momentDateFormats);
